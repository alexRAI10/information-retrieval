...
public class tiny_tokenize {
    public static void main(String[] args) {
        ...
        if (args.length != 2) {
            ...
            try {
                //Try/catch error in case input file not found
                din = new BufferedReader(new FileReader(InFilename));
                OutFilename = args[1];
                ...
                try {
                    ...
                    //Files will open, read and write the tokens
                    din.close();
                    dout.close();
                } catch (IOException e) {
